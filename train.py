...
train_set = CIFAR10('/data', train=True, transform=custom_transfroms(True), download=True)
val_set = CIFAR10('/data', train=False, transform=custom_transfroms(False))
